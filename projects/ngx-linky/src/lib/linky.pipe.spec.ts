...
describe('LinkyPipe', () => {
  ...
  it('should linkify the web urls', () => {
    const result = pipe.transform('google.com can search trough www.ebay.com and http://www.amazon.com');
  ...
  it('should correctly accept args', () => {
    const result = pipe.transform('google.com should be opened in the same window', { newWindow: false });
